...
class BankServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->loadMigrationsFrom(module_path('Bank', 'Database/Migrations'));
    }
    ...
    public function registerViews()
    {
        ...
        $sourcePath = module_path('Bank', 'Resources/views');
    ...
    public function registerTranslations()
    {
        ...
        if (is_dir($langPath)) {
            ...
            $this->loadTranslationsFrom(module_path('Bank', 'Resources/lang'), 'bank');
        }
    }
    ...
    public function registerFactories()
    {
        if (! app()->environment('production') && $this->app->runningInConsole()) {
            app(Factory::class)->load(module_path('Bank', 'Database/factories'));
        }
    }
