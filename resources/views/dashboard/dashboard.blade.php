            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-left" style="float: left;">
                        <h4 class="font-light mb-0"><i class="fas fa-dollar-sign"></i> 10.000,00</h4>
                    </div>
                    <div class="text-right mb-3">
                        <h4 class="font-light mb-0"><i class="fab fa-bitcoin"></i> 5.000,00</h4>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row d-flex flex-row">
                        <div class="col-lg-4 text-center"><img src="/vendor/wrappixel/monster-admin/4.2.1/assets/images/users/1.jpg" alt="user" class="img-circle" width="100"></div>
                    ...
                    <div class="row mt-5">
                        <div class="col border-right">
                            <h2 class="text-center font-light mb-0">20.000</h2>
                        ...
                        <div class="col">
                            <h2 class="text-center font-light mb-0">40.000</h2>
