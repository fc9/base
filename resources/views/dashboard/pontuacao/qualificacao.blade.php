...
@section('title', 'Ponto de Qualificação')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-3 d-flex align-items-center">
                            <div class="custom-control custom-radio custom-control-inline">
                                ...
                                <label class="custom-control-label" for="customRadioInline1">PV Esquerda</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="customRadioInline2" name="customRadioInline1" class="custom-control-input">
                                <label class="custom-control-label" for="customRadioInline2">PV Direita</label>
                            </div>
                        </div>
                    </div>
                    <div class="row">
