                ...
                <div class="card-body">
                    <div class="table-responsive m-t-40">
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                            <tr>
                                <th>ID PEDIDO</th> {{-- Store.order.id --}}
                                <th>USUÁRIO</th> {{-- username --}}
                                <th>NOME</th> {{-- $username --}}
                                <th>TOTAL</th> {{-- Store.amount --}}
                                <th>TIPO PAGAMENTO</th> {{-- Bitcoin (Invoice.) --}}
                                <th>DATA REGISTRO</th> {{-- Store.order.create_at --}}
                                {{--<th>FATURADO</th> {{-- Bank.transaction.status --}}
                                <th>STATUS</th> {{-- Bank.transaction.status --}}
                                <th>APROVAR</th> {{--  --}}
                                <th>APROVAR S. B.</th> {{--  --}}
                            ...
                            <tr>
                                ...
                                <td><span class="badge badge-info" style="color: #FFF !important; padding: 5px 20px;">CARRINHO</span></td>
